...
INSERT INTO animals(id, name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES(1006, 'Plantmon', '2021-11-15', 2, TRUE, -5.7);
...
INSERT INTO animals(id, name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES(1011, 'Ditto', '2022-05-14', 3, TRUE, 17);
...
INSERT INTO visits (animal_id, vets_id, date_of_visit) SELECT * FROM (SELECT id FROM animals) animal_ids, (SELECT id FROM vets) vets_ids, generate_series('1980-01-02'::timestamp, '2021-01-01', '4 hours') visit_timestamp;
